<%@ Page Title="View Order" Language="C#" MasterPageFile="~/Layouts/Fixed/Account.master" AutoEventWireup="True" CodeFile="Receipt.aspx.cs" Inherits="AbleCommerce.Checkout.Receipt" ViewStateMode="Disabled" %>
