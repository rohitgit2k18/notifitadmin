namespace AbleCommerce.Mobile.Members
{
    ...
    public partial class PayMyOrder : AbleCommercePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (order == null) Response.Redirect(NavigationHelper.GetMobileStoreUrl("~/Members/MyAccount.aspx"));
            if (order.User != null && order.User.Id != AbleContext.Current.UserId) Response.Redirect(NavigationHelper.GetMobileStoreUrl("~/Members/MyAccount.aspx"));

            // cannot make payment on invalid orders or orders with subscription payments
            string viewOrderUrl = Page.ResolveUrl(NavigationHelper.GetMobileStoreUrl("~/Members/MyOrder.aspx?OrderNumber=" + order.OrderNumber));
