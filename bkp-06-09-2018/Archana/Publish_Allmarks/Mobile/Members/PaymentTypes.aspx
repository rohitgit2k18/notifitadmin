<%@ Page Title="Payment Types" Language="C#" MasterPageFile="~/Layouts/Mobile.Master" AutoEventWireup="True" CodeFile="PaymentTypes.aspx.cs" Inherits="AbleCommerce.Mobile.Members.PaymentTypes" %>
<asp:Content ContentPlaceHolderID="HtmlHeader" runat="server">
                ...
                <div class="column_1">
                    <div class="section">
                        <asp:Panel ID="ReviewsCaptionPanel" runat="server" CssClass="header">
                            <h2><asp:Localize ID="ReviewsCaption" runat="server" Text="Payment Types" /></h2>
                        </asp:Panel>
                        <div class="content">
                            ...
                            <asp:Repeater ID="CardsList" runat="server" OnItemCommand="CardsList_ItemCommand">
                                ...
                                <ItemTemplate>
                                    ...
                                    <div class="paymentItem">
                                        ...
                                        <asp:Panel ID="ButtonsPanel" runat="server" CssClass="deleteLink" Visible='<%#CanBeDeleted((int)Eval("Id")) %>'>
                                            <asp:Button ID="DeletePaymentButton" runat="server" Text="Remove" CommandName="DELETE_PROFILE" CommandArgument='<%#Eval("Id") %>' OnClientClick="return confirm('Are you sure you want to delete?');" />
                                        </asp:Panel>
                                        <div class="clear"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="clear"></div>
                            <div id="DefaultButtonPanel" class="defaultButton" runat="server">
                ...
                <div class="column_2">
                    ...
                    <div class="inputForm">
                        ...
                        <div class="row">
                            ...
                            <div class="inputFied">
                                <asp:TextBox ID="CardName" runat="server" MaxLength="50" ValidationGroup="CreditCard" AutoCompleteType="Disabled" Width="135"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="inputFied">
                                <asp:TextBox ID="CardNumber" runat="server" MaxLength="19" ValidationGroup="CreditCard" Width="135"></asp:TextBox>
                        ...
                        <div id="trIntlCVV" runat="server" visible="true" class="row">
                            <div class="inputFied">
                        ...
                        <div id="trIntlInstructions" runat="server" visible="true" class="row">
                            <div>&nbsp;</div>
                            <div>
                        ...
                        <div id="trIssueNumber" runat="server" visible="true" class="row">
                            <div class="rowHeader">
                        ...
                        <div id="trStartDate" runat="server" visible="true" class="row">
                            <div class="rowHeader">
