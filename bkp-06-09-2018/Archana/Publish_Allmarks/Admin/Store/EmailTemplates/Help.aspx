<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin._Store.EmailTemplates.Help" Title="NVelocity Syntax Help" EnableViewState="false" CodeFile="Help.aspx.cs" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content">
        <p align="justify">
            ...
            <p>You might also have access to the "merchant" variable which will send an email to the default address designated for the store.</p>

            <p>The "vendor" variable will send an email to any vendor who's products were purchased in the order.</p>
            ...
            $order.TotalCharges.LSCurrencyFormat("lc")
