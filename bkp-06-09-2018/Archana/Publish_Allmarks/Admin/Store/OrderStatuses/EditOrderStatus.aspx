<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" Inherits="AbleCommerce.Admin._Store.OrderStatuses.EditOrderStatus" Title="Edit Order Status"  CodeFile="EditOrderStatus.aspx.cs" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="pageHeader">
    	<div class="caption">
    		<h1><asp:Localize ID="Caption" runat="server" Text="Edit Order Status"></asp:Localize></h1>
    	</div>
    </div>
    <div class="content">
    <cb:Notification ID="SavedMessage" runat="server" Text="Order Status saved at {0:t}" SkinID="GoodCondition" Visible="false"></cb:Notification>
        ...
        <table cellspacing="0" class="inputForm">
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBoxList ID="EmailTemplates" runat="server" RepeatColumns="3" RepeatDirection="vertical" DataSourceID="EmailTemplateDs" DataTextField="Name" DataValueField="EmailTemplateId" OnDataBound="EmailTemplates_DataBound" CellPadding="4">
                    </asp:CheckBoxList>
