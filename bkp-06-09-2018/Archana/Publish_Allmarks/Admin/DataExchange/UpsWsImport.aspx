<%@ Page Title="UPS WorldShip Import" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="True" CodeFile="UpsWsImport.aspx.cs" Inherits="AbleCommerce.Admin.DataExchange.UpsWsImport" %>
<%@ Register Src="~/Admin/ConLib/NavagationLinks.ascx" TagName="NavagationLinks" TagPrefix="uc1" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="pageHeader">
        <div class="caption">
            <h1><asp:Localize ID="Caption" runat="server" Text="UPS WorldShip&reg; Import"></asp:Localize></h1>
            ...
            <asp:Panel ID="OptionsPanel" runat="server" >
                ...
                <ContentTemplate>
                    ...
                    <table class="innerLayout" cellpadding="5" cellspacing="10" width="100%">
                        <tr>
                            <td>
                                <p>Select the file that contains the UPS WorldShip&reg; data. Simple text CSV files and CSV files compressed as zip are accepted. For files larger then <asp:Literal ID="UploadMaxSize" runat="server" Text="{0}KB" EnableViewState="false" /> use FTP to upload them to the server. For information on data format, see <a href="http://help.ablecommerce.com/mergedProjects/ablecommerceGold/index.htm#catalog/data_exchange/import_worldship_data.htm" target="_blank">UPS WorldShip&reg;</a> for Ablecommerce.</p>
