<%@ Page Title="Export Users" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="True" CodeFile="UsersExport.aspx.cs" Inherits="AbleCommerce.Admin.DataExchange.UsersExport" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="pageHeader">
        <div class="caption">
            <h1><asp:Localize ID="Caption" runat="server" Text="Export Users"></asp:Localize></h1>
        ...
        <ContentTemplate>
            <div class="section">
                <asp:PlaceHolder ID="ExportOptionsPanel" runat="server">
                    <p>
                        Click the export all users button to start export, or click filter users button
                        if you want export some selected users. It will take you to user manager page
                        where you can filter the users using the search panel and then proceed with export.</p>
                    <asp:HyperLink ID="ExportAllButton" runat="server" SkinID="Button" Text="Export All Users"
                        NavigateUrl="~/Admin/DataExchange/UsersExport.aspx?type=all" EnableViewState="false" />
                    <asp:HyperLink ID="ExportSelectedButton" runat="server" SkinID="Button" Text="Filter Users"
                        NavigateUrl="~/Admin/People/Users/Default.aspx" EnableViewState="false" />
                </asp:PlaceHolder>
                <asp:PlaceHolder ID="FieldSelectionPanel" runat="server" Visible="false">
                    <div class="header">
                        <h2>
                            <asp:Localize ID="ExportCaption" runat="server" Text="Export {0} Users"></asp:Localize></h2>
                    </div>
                    <div class="content">
                        <table class="inputForm">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:PlaceHolder ID="CSVFieldsPanel" runat="server">
                                        <p>
                                            Please select the fields to be included in user export.<asp:CustomValidator runat="server"
                                        ...
                                        <asp:CheckBoxList ID="FieldNamesList" runat="server" RepeatLayout="Table" RepeatColumns="4">
                                        </asp:CheckBoxList>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Button ID="StartExportButton" runat="server" Text="Export Users" OnClick="StartExportButton_Click"
                                        ValidationGroup="Export" />
                                </td>
                            </tr>
                        </table>
                ...
                <asp:PlaceHolder ID="ProgressPanel" runat="server" Visible="false">
                    ...
                    <p>
                        <asp:Localize ID="ProgressLabel" runat="server" Text="Total Users: {0} Exported: {1}"
                ...
                <cb:Notification ID="ExportCompleteMessage" runat="server" Text="Users export complete at {0:t}"
