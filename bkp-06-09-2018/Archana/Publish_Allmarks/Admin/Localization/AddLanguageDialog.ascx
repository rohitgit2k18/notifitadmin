<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddLanguageDialog.ascx.cs" Inherits="AbleCommerce.Admin.Localization.AddLanguageDialog" %>
        ...
        <table class="inputForm">
            <tr>
                ...
                <td nowrap>
                    ...
                    <asp:RegularExpressionValidator ID="RegExNameValidator" runat="server" ErrorMessage="Maximum length for Name is 100 characters." Text="*" ControlToValidate="Name" ValidationExpression=".{0,100}"  ValidationGroup="AddLanguage"></asp:RegularExpressionValidator>
                    <asp:RequiredFieldValidator ID="NameValidator" runat="server" ControlToValidate="Name"
                        Display="Static" ErrorMessage="Name is required." ValidationGroup="AddLanguage" Text="*"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:Button ID="SaveButton" SkinId="SaveButton" runat="server" Text="Save" OnClick="SaveButton_Click" ValidationGroup="AddLanguage" />
                </td>
            </tr>
        </table>
    </ContentTemplate>
