<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Payment.AddPaymentMethodDialog" CodeFile="AddPaymentMethodDialog.ascx.cs" %>
...
<table cellspacing="0" class="inputForm" width="100%">
    ...
    <tr>
        <td>&nbsp;</td>
        <td>
            <asp:Button ID="AddButton" runat="server" Text="Add" SkinID="AddButton" OnClick="AddButton_Click" ValidationGroup="AddDialog" />
        </td>
    </tr>
</table>
