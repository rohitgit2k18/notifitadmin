<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Payment.EditPaymentMethodDialog" CodeFile="EditPaymentMethodDialog.ascx.cs" %>
...
<table cellspacing="0" class="inputForm" width="100%">
    ...
    <tr id="trAllowSubscriptionPayments" runat="server">
        <th></th>
        <td>
            <asp:CheckBox ID="AllowSubscriptionPayments" runat="server" Text="Allow subscription payments" /><asp:Literal ID="refStar" runat="server"><span style="font-size:2em;padding:3px;color:#2244FF;">*</span></asp:Literal>
        </td>
    </tr>
    <tr>
        <th valign="top">
    ...
    <tr runat="server" id="refStarTr">
        <td colspan="4"><span style="font-size:2em;padding:3px;color:#2244FF;">*</span>This setting applies only when you have recurring orders feature enabled.</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td class="dialogSubmit">            
            <asp:Button ID="SaveButton" runat="server" OnClick="SaveButton_Click" Text="Save" SkinID="SaveButton" ValidationGroup="EditPaymentMethod"></asp:Button>
			<asp:Button ID="CancelButton" runat="server" OnClick="CancelButton_Click" Text="Cancel" SkinID="CancelButton" ValidationGroup="EditPaymentMethod" CausesValidation="false"></asp:Button>
        </td>
    </tr>
</table>