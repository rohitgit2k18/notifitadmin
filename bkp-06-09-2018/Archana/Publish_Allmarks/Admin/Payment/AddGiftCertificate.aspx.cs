...
{
public partial class AddGiftCertificate : CommerceBuilder.UI.AbleCommerceAdminPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {			
			int daysToExpire = AbleContext.Current.Store.Settings.GiftCertificateDaysToExpire;
			if(daysToExpire > 0) {
