<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Marketing.FeaturedProducts" Title="Featured Products" CodeFile="FeaturedProducts.aspx.cs" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content">
            <p><asp:Localize ID="InstructionText" runat="server" Text="Featured Products are automatically displayed in random order on pages or sidebars where the Featured Products control is included."></asp:Localize></p>
            </div>
            ...
            <table cellspacing="0" class="inputForm">
                <tr>
                    <th>
                        <asp:Label ID="NameLabel" runat="server" Text="Name:"></asp:Label>mmmmmmmmmmmmmmmm
                    </th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="FeaturedFilter" runat="server">
                            ...
                            <asp:ListItem Text="Featured Products Only" Value="True" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Non-Featured Products Only" Value="False"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <th>
                ...
                <tr>
                    ...
                    <td colspan="5">
                        ...
                        <asp:HyperLink ID="FinishLink" runat="server" SkinID="CancelButton" Text="Cancel" NavigateUrl="../Default.aspx" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <div class="content">
            <cb:AbleGridView ID="PG" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductId"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Link">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="AttachButton" runat="server" CommandArgument='<%#Container.DataItemIndex%>' AlternateText="Add" ToolTip="Add" SkinId="AddIcon" OnClientClick="this.visible=false" OnClick="AttachButton_Click" Visible='<%#!IsProductFeatured(((Product)Container.DataItem).Id)%>' />
                            <asp:ImageButton ID="RemoveButton" runat="server" CommandArgument='<%#Container.DataItemIndex%>' AlternateText="Remove" ToolTip="Remove" SkinId="DeleteIcon" OnClientClick="this.visible=false" OnClick="RemoveButton_Click" Visible='<%#IsProductFeatured(((Product)Container.DataItem).Id)%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
            ...
            <div id="gridFooter" runat="server" clientidmode="Static">
                ...
                <asp:DropDownList ID="GridActions" runat="server">
                    ...
                    <asp:ListItem Text="Mark as Featured" Value="True"></asp:ListItem>
