<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Marketing.Coupons.EditCoupon" Title="Edit Coupon" CodeFile="EditCoupon.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content">
        <cb:Notification ID="SavedMessage" runat="server" Text="Saved at {0:t}" Visible="false" EnableViewState="false" SkinID="GoodCondition"></cb:Notification>
        ...
        <table cellspacing="0" class="inputForm">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="DiscountAmount" runat="server" Text="" Width="50px" MaxLength="8"></asp:TextBox>
                    ...
                    <span class="requiredField">*</span><asp:RequiredFieldValidator ID="DiscountRequired" runat="server" Text="*" Display="Static" ErrorMessage="Discount is required." ControlToValidate="DiscountAmount"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="CouponCode" runat="server" Text="" Width="200px" MaxLength="50"></asp:TextBox><span class="requiredField">*</span>
                    ...
                    <asp:PlaceHolder ID="phCouponCodeValidator" runat="server" EnableViewState="false"></asp:PlaceHolder>
                </td>
                <th>
            ...
            <tr id="trValue" runat="server">
                ...
                <td>
                    <asp:TextBox ID="MaxValue" runat="server" Text="" Width="100px" MaxLength="8"></asp:TextBox>
                ...
                <td>
                    <asp:TextBox ID="MinPurchase" runat="server" Text="" Width="100px" MaxLength="8"></asp:TextBox>
            ...
            <tr id="trQuantity" runat="server"> 
                ...
                <td>
                    <asp:TextBox ID="Quantity" runat="server" Text="" Width="100px" MaxLength="4"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="MaximumUsesPerCustomer" runat="server" Text="" Width="100px" MaxLength="4"></asp:TextBox>
                ...
                <td>
                    <asp:TextBox ID="MaximumUses" runat="server" Text="" Width="100px" MaxLength="4"></asp:TextBox>
            ...
            <tr id="trProductRule" runat="server">
                ...
                <td colspan="3">
                    <asp:UpdatePanel ID="ProductRuleAjax" runat="server" UpdateMode="conditional">
                        <ContentTemplate>
                            ...
                            <asp:Panel ID="ProductRulePanel" runat="server" Visible="false">
                                <br />
                                <asp:Label ID="ProductCount" runat="server" Text="{0} Product(s) selected"></asp:Label>
                                <br />
                                <asp:LinkButton ID="ManageCouponProducts" runat="server" Text="Change" OnClick="ManageCouponProducts_Click" SkinID="Link" CausesValidation="true"></asp:LinkButton>
                            </asp:Panel>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            ...
            <tr id="trShipMethodRule" runat="server">
                ...
                <td colspan="3">
                    <asp:UpdatePanel ID="ShipMethodRuleAjax" runat="server" UpdateMode="conditional">
                        <ContentTemplate>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <asp:Button ID="SaveAndCloseButton" runat="server" SkinID="SaveButton" Text="Save and Close" OnClick="SaveButton_Click" />
