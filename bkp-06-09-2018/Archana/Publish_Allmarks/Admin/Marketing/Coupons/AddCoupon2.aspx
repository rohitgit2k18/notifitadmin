<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Marketing.Coupons.AddCoupon2" Title="Add Coupon" CodeFile="AddCoupon2.aspx.cs" %>
    ...
    <div class="content">
        ...
        <table cellspacing="0" class="inputForm">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="CouponCode" runat="server" Text="" Columns="10" MaxLength="50"></asp:TextBox><span class="requiredField">*</span>
            ...
            <tr>
                ...
                <td valign="top" colspan="3">
                    <asp:UpdatePanel ID="ComboRuleAjax" runat="server" UpdateMode="conditional">
                        <ContentTemplate>
