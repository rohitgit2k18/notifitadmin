...
{
public partial class ShoppingCom : AbleCommerceAdminPage
{
    ...
    String KeyFeedStatus = "CommerceBuilder_ShoppingCom_Store" + AbleContext.Current.StoreId + "_FeedStatus";
    String KeyFeedStatusMessageList = "CommerceBuilder_ShoppingCom_Store" + AbleContext.Current.StoreId + "_MessageList";
    String KeyFeedStatusMessage = "CommerceBuilder_ShoppingCom_Store" + AbleContext.Current.StoreId + "_Message";
    String KeyFeedStatusPercent = "CommerceBuilder_ShoppingCom_Store" + AbleContext.Current.StoreId + "_Percent";
    String KeyFeedStatusSuccess = "CommerceBuilder_ShoppingCom_Store" + AbleContext.Current.StoreId + "_Success";
    ...
    protected FeedOptions GetPostedOptions()
    {
        ...
        options.StoreId = AbleContext.Current.StoreId;
        return options;
    }
    ...
    protected void UpdateMessagePanel(bool success, IList<string> messages)
    {
    ...
    protected void PopulateMessages(IList<string> messages)
    {
    ...
    protected void FeedActionButton_Click(object sender, EventArgs e)
    {
