<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" Inherits="AbleCommerce.Admin.Shipping.Countries.AddressFormat" Title="Address Format Help"  CodeFile="AddressFormat.aspx.cs" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content">
        <p style="text-align:justify">When adding or updating a country, you may need to adjust the rules for address formatting for that locale.
        ...
        <p style="text-align:justify">For any of the variable, you can add "_U" to the end to force the value to upper case.  For example, "[Country_U]" will 
