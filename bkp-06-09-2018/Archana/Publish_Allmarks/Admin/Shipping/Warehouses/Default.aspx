<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" Inherits="AbleCommerce.Admin.Shipping.Warehouses._Default" Title="Manage Warehouses"  CodeFile="Default.aspx.cs" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="grid_8 alpha">
        <div class="mainColumn">
            <div class="content">
                <asp:HyperLink ID="AddWarehouse" runat="server" Text="Add Warehouse" NavigateUrl="AddWarehouse.aspx" SkinID="AddButton"></asp:HyperLink>
                <p><asp:Localize ID="InstructionText" runat="server" Text="The primary Warehouse is simply your store's main address.  It will be displayed on invoices, and used to calculate shipping and tax, if applicable.  By providing additional warehouses, you can create unique shipping and tax locations for your items."></asp:Localize></p>
                <asp:UpdatePanel ID="WarehouseAjax" runat="server" UpdateMode="Always">
                    <ContentTemplate>
    ...
    <div class="grid_4 omega">
        <div class="rightColumn">
            <div class="section">
                ...
                <div class="content">
                    <asp:UpdatePanel ID="DefaultWarehouseAjax" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <p><asp:Localize ID="DefaultWarehouseHelpText" runat="server" Text="Select the warehouse that represents the primary physical location of your store or business headquarters.  This is called the &quot;primary warehouse&quot; even if products do not ship from this location."></asp:Localize></p>
