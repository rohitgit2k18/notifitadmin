<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" Inherits="AbleCommerce.Admin.Shipping.Warehouses.EditWarehouse" Title="Edit Warehouse"  CodeFile="EditWarehouse.aspx.cs" %>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content">
        <asp:UpdatePanel ID="EditAddressAjax" runat="server">
            <ContentTemplate>
                <cb:Notification ID="SavedMessage" runat="server" Text="Warehouse settings saved at {0:t}" SkinID="GoodCondition" Visible="false"></cb:Notification>
