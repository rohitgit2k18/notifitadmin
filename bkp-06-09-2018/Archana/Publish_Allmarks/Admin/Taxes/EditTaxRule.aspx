<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Taxes.EditTaxRule" Title="Edit Tax Rule" CodeFile="EditTaxRule.aspx.cs" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:UpdatePanel ID="TaxRuleAjax" runat="server">
        <ContentTemplate>
            <div class="pageHeader">
        	    <div class="caption">
        		    <h1><asp:Localize ID="Caption" runat="server" Text="Edit Tax Rule {0}" EnableViewState="false"></asp:Localize></h1>
        	    </div>
            </div>
            <div class="content">
            <cb:Notification ID="SavedMessage" runat="server" Text="Tax Rule Updated at {0:t}" SkinID="GoodCondition" Visible="false"></cb:Notification>
