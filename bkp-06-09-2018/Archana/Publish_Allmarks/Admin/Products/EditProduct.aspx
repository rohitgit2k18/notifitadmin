<%@ Page Language="C#" MasterPageFile="~/Admin/Products/Product.master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Products.EditProduct" Title="Edit Product '{0}'" CodeFile="EditProduct.aspx.cs" EnableViewState="true" ViewStateMode="Disabled" %>
<%@ Register Src="~/Admin/UserControls/PickerAndCalendar.ascx" TagName="PickerAndCalendar" TagPrefix="uc" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="pageHeader">
        <div class="caption">
            <h1><asp:Localize ID="Caption" runat="server" Text="{0}"></asp:Localize></h1>
            <div class="links">
                ...
                <asp:Button ID="DeleteButton" runat="server" Text="Delete" SkinID="SaveButton" OnClick="DeleteButton_Click"></asp:Button>
    ...
    <div class="content">
            ...
            <tr>
                ...
                <td>
                    <asp:UpdatePanel ID="ManufacturerAjax" runat="server" UpdateMode="conditional" ViewStateMode="Enabled">
                        <ContentTemplate>
                            <asp:DropDownList ID="ManufacturerList" runat="server" DataSourceID="ManufacturerDs" DataTextField="Name" DataValueField="ManufacturerId" AppendDataBoundItems="True" OnDataBound="ManufacturerList_DataBound" Width="175px">
        ...
        <asp:UpdatePanel ID="InventoryAjax" runat="server" UpdateMode="conditional">
            <ContentTemplate>
                <table cellspacing="0" class="inputForm">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="billableLink"><asp:LinkButton ID="billableWeightLink" runat="server" Text="View Billable Weight" OnClientClick="ShowModalPopup()"></asp:LinkButton></span>
                        </td>
                        <th>
                        ...
                        <td>
                            <asp:DropDownList ID="Vendor" runat="server" DataSourceID="VendorDs" DataTextField="Name"
                                DataValueField="VendorId" AppendDataBoundItems="True" OnDataBound="Vendor_DataBound" Width="175px">
                                <asp:ListItem Value="" Text=""></asp:ListItem>
                            </asp:DropDownList>
                    ...
                    <tr id="trProductInventory" runat="server" visible="false" enableviewstate="true">
                        ...
                        <td>
                            <uc:PickerAndCalendar ID="AvailabilityDate" runat="server" />
                        </td>                        
                    </tr>
                    <tr>
                ...
                <asp:Panel ID="BillableWeightDialog" runat="server" Style="display: none" CssClass="modalPopup" Width="400px">
                    <asp:Panel ID="BillableWeightDialogHeader" runat="server" CssClass="modalPopupHeader">
                        Billable Weight
                    </asp:Panel>
                    <div id="billableDialog">
                    <div class="productWeightCaption">
                        <div class="weightCaption">
                            <asp:Literal ID="PWeightCaption" runat="server" Text="Product Weight = "></asp:Literal>
                        </div>
                        <div class="weight">
                            <asp:Label ID="ProductWeightLabel" runat="server" Text="{0:F2} Pounds"></asp:Label>
                        </div>
                    </div>
                    <div class="dimensionalWeight">
                        <asp:Label ID="DimensionalWeightLabel" runat="server" Text="UPS® and FEDEX® Dimensional Weight :"></asp:Label>
                    </div>
                    <div id="trDimensionalWeightText" runat="server" visible="false"> 
                        <p><asp:Label ID="DimensionalWeightText" runat="server" Text="Product dimensions are required to calculate dimensional weight."></asp:Label></td>
                    </div>
                    <div id="trDomesticWeight" runat="server" class="productWeightCaption">
                        <div class="weightLabel">
                            <asp:Label ID="DomesticCaption" runat="server" Text="Domestic = "></asp:Label>
                        </div>
                        <div class="weightValue">
                            <asp:Label ID="DomesticLabel" runat="server" Text="{0:F2} Pounds"></asp:Label>
                        </div>
                    </div>
                    <div id="trInternationalWeight" runat="server" class="intelWeight">
                        <div class="intelWeightCaption">
                            <asp:Label ID="InternationalCaption" runat="server" Text="International = "></asp:Label>
                        </div>
                        <div class="weightValue">
                            <asp:Label ID="InternationalLabel" runat="server" Text="{0:F2} Pounds"></asp:Label>
                        </div>
                    </div>
                    <div class="link">
                         <asp:HyperLink ID="CloseLink" runat="server" Text="Close" SkinID="CancelButton" ViewStateMode="Enabled"></asp:HyperLink>
                    </div>
                </div>
                </asp:Panel>
                <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender" runat="server" 
                    TargetControlID="billableWeightLink"
                    PopupControlID="BillableWeightDialog" 
                    BackgroundCssClass="modalBackground" 
                    CancelControlID="CloseLink" 
                    DropShadow="true"
                    PopupDragHandleControlID="BillableWeightDialogHeader" />
                </ContentTemplate>
            </asp:UpdatePanel>
        <div class="sectionHeader">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DisplayPage" runat="server" DataSourceID="DisplayPageDs" DataTextField="Name" 
                        DataValueField="Id" AppendDataBoundItems="true" OnDataBound="DisplayPage_DataBound">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="WrapGroup" runat="server" DataSourceID="GiftWrapDs" DataTextField="Name"
                        DataValueField="WrapGroupId" AppendDataBoundItems="true" OnDataBound="WrapGroup_DataBound">
                        <asp:ListItem Value="" Text=""></asp:ListItem>
                    </asp:DropDownList>
        ...
        <div>
            <div class="UploadPDF">
                <asp:Literal ID="FileName1" runat="server"></asp:Literal>
                <asp:FileUpload ID="FileUpload1" runat="server" /><br />
                <asp:Button ID="buttonUpload" runat="server" Text="Upload" OnClick="UploadButton_Click1" /><br />
            </div>
            <br />
            <div class="UploadPDF">
                <asp:Literal ID="FileName2" runat="server"></asp:Literal>
                <asp:FileUpload ID="FileUpload2" runat="server" /><br />
                <asp:Button ID="button1" runat="server" Text="Upload" OnClick="UploadButton_Click2" /><br />
            </div>
            <br />
            <div class="UploadPDF">
                <asp:Literal ID="FileName3" runat="server"></asp:Literal>
                <asp:FileUpload ID="FileUpload3" runat="server" /><br />
                <asp:Button ID="button2" runat="server" Text="Upload" OnClick="UploadButton_Click3" /><br />
            </div>
        </div>
        <div class="sectionHeader">
        ...
        <br />
        <div class="links">
            <asp:Button ID="SaveButton2" runat="server" Text="Save" SkinID="SaveButton" OnClick="SaveButton_Click"></asp:Button>
            ...
            <asp:Button ID="DeleteButton1" runat="server" Text="Delete" SkinID="SaveButton" OnClick="DeleteButton_Click"></asp:Button>
