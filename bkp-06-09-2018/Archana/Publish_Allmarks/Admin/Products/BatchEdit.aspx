<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Products.BatchEdit" Title="Product Batch Editing" EnableViewState="false" CodeFile="BatchEdit.aspx.cs" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
<div class="pageHeader">
	<div class="caption">
		<h1><asp:Localize ID="Caption" runat="server" Text="Batch Edit Products"></asp:Localize></h1>
        <div class="links">
            ...
            <cb:NavigationLink ID="BatcheditLinkProd" runat="server" Text="Batch Edit Products" SkinID="ActiveButton" NavigateUrl="#"></cb:NavigationLink>
                ...
                <table width="100%">
                    <tr>
                        <td valign="top" width="350px">
                            <p>
                                <asp:Label ID="SearchHelpText" runat="server" SkinID="FieldHeader" Text="Search for the product(s) to edit:"></asp:Label>
                            </p>
                            <table class="inputForm" cellpadding="2" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:HyperLink ID="ResetSearchButton" runat="server" Text="Reset" SkinID="CancelButton" NavigateUrl="BatchEdit.aspx"></asp:HyperLink>
                                    </td>
                                </tr>
                            </table>
