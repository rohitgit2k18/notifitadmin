<%@ Page Language="C#" MasterPageFile="~/Admin/Products/Product.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Products.DigitalGoods.AttachDigitalGood" Title="Attach Digital Good" CodeFile="AttachDigitalGood.aspx.cs" %>
        ...
        <ContentTemplate>
                ...
                <table class="inputForm compact">
                    <tr>
                        ...
                        <td nowrap>
                            ...
                            <asp:HyperLink ID="CancelButton" runat="server" Text="Cancel" SkinID="CancelButton" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
            <div class="content">
                <cb:SortedGridView ID="SearchResultsGrid" runat="server" AutoGenerateColumns="false" 
                    ShowHeader="true" ShowFooter="false" DataKeyNames="DigitalGoodId" SkinID="PagedList"
