<%@ Page Language="C#" MasterPageFile="../Product.master" Inherits="AbleCommerce.Admin.Products.Assets.UploadAdditionalImage" Title="Upload Image"  EnableViewState="false" CodeFile="UploadAdditionalImage.aspx.cs" %>
...
<div class="content">
    <p><asp:Localize ID="UploadHelpText" runat="server" Text="Upload an additional image for this product.  If desired, we can resize the image to your specifications."></asp:Localize></p>
    ...
    <table class="inputForm">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Localize ID="FileDataMaxSize" runat="server" Text="({0}KB max)" EnableViewState="false"></asp:Localize><span class="requiredField">*</span>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="BaseFileName" runat="server" Width="200px"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="Moniker" runat="server" Width="200px" MaxLength="255"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th valign="top">
                <asp:Label ID="ResizeLabel" runat="server" Text="Resize Options:" AssociatedControlID="Resize" ToolTip="Indicates whether the image should be resized on upload."></asp:Label>
            </th>
            <td valign="top">
                <table cellpadding="2">
                    <tr>
