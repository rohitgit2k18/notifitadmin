<%@ Page Language="C#" MasterPageFile="../Product.master" Inherits="AbleCommerce.Admin.Products.Specials.EditSpecial" Title="Edit Pricing Rule"  CodeFile="EditSpecial.aspx.cs" %>
<%@ Register Src="~/Admin/UserControls/PickerAndCalendar.ascx" TagName="PickerAndCalendar" TagPrefix="uc" %>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="pageHeader">
        <div class="caption">
            <h1><asp:Localize ID="Caption" runat="server" Text="Editing Special Price for {0}"></asp:Localize></h1>
        </div>
    </div>        
    <div class="content">
        ...
        <cb:Notification ID="SavedMessage" runat="server" Text="Special price saved at {0:t}<br />" Visible="false" EnableViewState="false" SkinID="GoodCondition"></cb:Notification>
        ...
        <table cellspacing="0" class="inputForm">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="Price" runat="server" Text="" Columns="10" MaxLength="11"></asp:TextBox><span class="requiredField">*</span>
