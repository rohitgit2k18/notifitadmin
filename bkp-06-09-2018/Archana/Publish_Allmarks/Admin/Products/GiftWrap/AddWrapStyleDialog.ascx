<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Products.GiftWrap.AddWrapStyleDialog" CodeFile="AddWrapStyleDialog.ascx.cs" %>
<asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="AddWrapStyle" />
<cb:Notification ID="AddedMessage" runat="server" Text="Wrap style {0} added." SkinID="GoodCondition" EnableViewState="false" Visible="false"></cb:Notification>
