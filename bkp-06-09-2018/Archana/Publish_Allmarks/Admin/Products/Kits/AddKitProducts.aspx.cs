namespace AbleCommerce.Admin.Products.Kits
{
    ...
    public partial class AddKitProducts : CommerceBuilder.UI.AbleCommerceAdminPage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!_DisplayCategorySearch) InitializeCategoryTree();
            else
            {
        ...
        protected void ResetButton_Click(object sender, EventArgs e)
        {
            ...
            SkuFilter.Text = string.Empty;
            ManufacturerFilter.SelectedIndex = 0;
            VendorFilter.SelectedIndex = 0;
        ...
        protected void SelectedProductRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                PlaceHolder phOptions = (PlaceHolder)AbleCommerce.Code.PageHelper.RecursiveFindControl(e.Item, "phOptions");
                Product p = (Product)e.Item.DataItem;
                phOptions.Controls.Clear();
                Dictionary<int, int> selectedOptions = AbleCommerce.Code.ProductHelper.BuildProductOptions(p, phOptions, true);
                ...
                {
                    _SelectedOptions.Add(new RowOptionChoice(e.Item.ItemIndex, p.Id, optionId, selectedOptions[optionId]));
                }
            }
        }
