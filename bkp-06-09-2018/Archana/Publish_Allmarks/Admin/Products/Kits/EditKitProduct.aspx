<%@ Page Language="C#" MasterPageFile="../Product.master" Inherits="AbleCommerce.Admin.Products.Kits.EditKitProduct" Title="Edit Kit Product"  CodeFile="EditKitProduct.aspx.cs" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="pageHeader">
        <div class="caption">
            <h1><asp:Localize ID="Caption" runat="server" Text="Edit Kit Product in {0}"></asp:Localize></h1>
        </div>
    </div>
    <div class="content">
        <p><asp:Label ID="InstructionText" runat="server" Text="You may override the default product settings for name, price, weight, or quantity. Any changes made here will apply to this kit component only."></asp:Label></p>
            ...
            <ContentTemplate>
                <table class="inputForm">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <asp:UpdatePanel id="PriceModePanel" runat="server">
                                <ContentTemplate>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <asp:UpdatePanel id="WeightModePanel" runat="server">
                                <ContentTemplate>
