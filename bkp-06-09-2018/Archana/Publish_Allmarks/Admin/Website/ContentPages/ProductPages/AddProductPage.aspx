<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Website.ContentPages.ProductPages.AddProductPage" Title="Add Product Page" CodeFile="AddProductPage.aspx.cs" %>
<%@ Register src="~/Admin/ConLib/CategoryTree.ascx" tagname="CategoryTree" tagprefix="uc" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="pageHeader">
        <div class="caption">
            <h1><asp:Localize ID="Caption" runat="server" Text="Add Product Page"></asp:Localize></h1>
            <div class="links">
        ...
        <div class="content">
         ...
         <div class="links">
            <asp:Button ID="Button1" runat="server" Text="Save and Edit" SkinID="SaveButton" OnClick="FinishButton_Click" />
            <asp:HyperLink ID="HyperLink1" runat="server" Text="Cancel" SkinID="CancelButton" NavigateUrl="Default.aspx" />
        </div>
        </div>
</asp:Content>