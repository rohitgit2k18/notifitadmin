<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Website.ContentPages.ProductPages.EditProductPage" Title="Edit Product Page" CodeFile="EditProductPage.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <cb:Notification ID="SavedMessage" runat="server" Text="Product display page saved at {0:t}" SkinID="GoodCondition" EnableViewState="False" Visible="false"></cb:Notification>
