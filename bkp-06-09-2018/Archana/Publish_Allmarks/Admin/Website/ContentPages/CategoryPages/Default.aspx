<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Website.ContentPages.CategoryPages._Default" Title="Manage Category Pages" CodeFile="Default.aspx.cs" %>
    ...
    <asp:UpdatePanel ID="ContentAjax" runat="server">
        <ContentTemplate>
            <div class="pageHeader">
                <div class="caption">
                    <h1><asp:Localize ID="Caption" runat="server" Text="Manage Category Pages"></asp:Localize></h1>
                    <uc1:NavagationLinks ID="NavigationLinks" runat="server" Path="website" />
                </div>
            </div>
            <div class="content">
                <asp:Button ID="NewPageButton" runat="server" Text="Add Category Page" OnClick="NewPageButton_Click" SkinID="AddButton" />
                <asp:Button ID="ChangeDefaultButton" runat="server" Text="Change Default" OnClick="ChangeDefaultButton_Click"  />
                <p><asp:Localize ID="DefaultThemesHelpText" runat="server" Text="You can set the store level default category page. For items that do not have a specific category display page selected, the default category display page will be used."></asp:Localize></p>
                <cb:AbleGridView ID="WebpagesGrid" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Name" SortExpression="Name">
                            ...
                            <ItemTemplate>
                                <a href="<%# string.Format("EditCategoryPage.aspx?WebpageId={0}", Eval("WebpageId")) %>"><%# Eval("Name") %></a>
                             </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Categories">
                            ...
                            <ItemStyle HorizontalAlign="Center" Width="50px" />
                            <ItemTemplate>
                                <a href="CategoryPageUsage.aspx?WebpageId=<%#Eval("Id")%>">
                                <%#GetCategoryCount(Container.DataItem)%>
                                </a>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="EditLink" runat="server" NavigateUrl='<%# string.Format("EditCategoryPage.aspx?WebpageId={0}", Eval("WebpageId")) %>'>
                    ...
                    <EmptyDataTemplate>
                        There are no category pages to list.
                    </EmptyDataTemplate>
                </cb:AbleGridView>
        ...
        <asp:Panel ID="ChangeDefaultDialog" runat="server" Style="display: none; width: 650px"
            ...
            <asp:Panel ID="ChangeDefaultHeader" runat="server" CssClass="modalPopupHeader">
                <h2>
                    <asp:Localize ID="DefaultThemesCaption" runat="server" Text="Change Default Category Display Page"></asp:Localize></h2>
            </asp:Panel>
            <div class="content">
                <table class="inputForm">
                    <tr>
                        <th>
                            <asp:Label ID="CategoriesLabel" runat="server" Text="Category Display Page:" AssociatedControlID="CategoriesDefault" />
                        </th>
                        <td>
                            <asp:DropDownList ID="CategoriesDefault" runat="server" DataTextField="Name"
                                DataValueField="Id">
                            </asp:DropDownList>
                        </td>
                    </tr>
