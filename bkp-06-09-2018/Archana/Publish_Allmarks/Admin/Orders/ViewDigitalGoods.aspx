<%@ Page Language="C#" MasterPageFile="Order.master" Inherits="AbleCommerce.Admin.Orders.ViewDigitalGoods" Title="Digital Goods" CodeFile="ViewDigitalGoods.aspx.cs" %>
<asp:Content ID="PageHeader" ContentPlaceHolderID="PageHeader" Runat="Server">
    <div class="pageHeader">
        <div class="caption">
            <h1><asp:Localize ID="Caption" runat="server" Text="Digital Goods - Order #{0}" EnableViewState="false"></asp:Localize></h1>
            <div class="links">
                <asp:HyperLink ID="AttachLink" runat="server" SkinID="AddButton" Text="Add Digital Good" NavigateUrl="~/Admin/Orders/AddDigitalGoods.aspx?OrderNumber={0}"></asp:HyperLink>
            </div>
        </div>
    </div>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="content">
        <asp:UpdatePanel ID="DigitalGoodsAjax" runat="server">
            <ContentTemplate>
                <asp:GridView ID="DigitalGoodsGrid" runat="server" AutoGenerateColumns="false" AllowPaging="false" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Activated" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Literal ID="ActivationDate" runat="server" Text='<%# Eval("ActivationDate", "{0:g}") %>' Visible='<%#HasDate(Eval("ActivationDate"))%>' EnableViewState="false"></asp:Literal>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Downloaded" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Literal ID="FirstDownload" runat="server" Text='<%# Eval("DownloadDate", "{0:g}") %>' Visible='<%#HasDate(Eval("DownloadDate"))%>' EnableViewState="False"></asp:Literal>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="# Downloads" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a href="ViewDownloads.aspx?OrderNumber=<%#Eval("OrderItem.Order.OrderNumber")%>&OrderItemDigitalGoodId=<%# Eval("OrderItemDigitalGoodId")%>"><%#Eval("RelevantDownloads")%></a>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Button ID="Activate" runat="Server" Text="Activate" CommandName="Activate" CommandArgument='<%#Eval("OrderItemDigitalGoodId")%>' Visible='<%#((OrderItemDigitalGood)Container.DataItem).DigitalGood != null && !HasDate(Eval("ActivationDate"))%>' EnableViewState="false" />
                ...
                <ajaxToolkit:ModalPopupExtender ID="EditKeyPopup" runat="server" 
