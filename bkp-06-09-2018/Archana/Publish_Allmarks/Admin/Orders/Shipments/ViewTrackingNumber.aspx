<%@ Page Language="C#" MasterPageFile="../Order.master" Inherits="AbleCommerce.Admin.Orders.Shipments.ViewTrackingNumber" Title="View Tracking Details" CodeFile="ViewTrackingNumber.aspx.cs" %>
