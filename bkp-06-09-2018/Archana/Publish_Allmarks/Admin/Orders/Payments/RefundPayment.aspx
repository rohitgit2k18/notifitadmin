<%@ Page Language="C#" MasterPageFile="~/Admin/Orders/Order.master" Inherits="AbleCommerce.Admin.Orders.Payments.RefundPayment" Title="Refund Payment" CodeFile="RefundPayment.aspx.cs" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content">
        <p>Enter the refund amount you wish to send the customer and click <b>Refund</b>.</p>
        ...
        <table cellspacing="0" class="inputForm">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="CreditCardNumber" runat="server" width="150px" MaxLength="19"></asp:TextBox><span class="requiredField">*</span>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="CheckBankName" runat="server" Width="100px"></asp:TextBox><span class="requiredField">*</span>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="CheckRoutingNumber" runat="server" Width="100px"></asp:TextBox><span class="requiredField">*</span>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="CheckAccountHolderName" runat="server" Width="100px"></asp:TextBox><span class="requiredField">*</span>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="CheckAccountNumber" runat="server" Width="100px"></asp:TextBox><span class="requiredField">*</span>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="CancelRefundButton" runat="server" Text="Cancel" SkinID="CancelButton" OnClick="CancelRefundButton_Click" CausesValidation="false"></asp:Button>
                </td>
            </tr>
        </table>
    </div>
