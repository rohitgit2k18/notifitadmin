<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Orders.Payments.ucProcessPayment" CodeFile="ucProcessPayment.ascx.cs" %>
        ...
        <table class="inputForm">
            ...
            <asp:PlaceHolder ID="CreditCardPanel" runat="server">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="CreditCardPaymentAmount" runat="server" Columns="8" ValidationGroup="CreditCard"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="CardName" runat="server" MaxLength="50" ValidationGroup="CreditCard" AutoCompleteType="Disabled"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="CardNumber" runat="server" MaxLength="19" ValidationGroup="CreditCard"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:textbox id="SecurityCode" runat="server" Columns="4" ValidationGroup="CreditCard"></asp:textbox><span class="requiredField">*</span>
            ...
            <asp:PlaceHolder ID="CheckPanel" runat="server">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="CheckPaymentAmount" runat="server" ValidationGroup="Check"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox id="AccountHolder" runat="server" MaxLength="50" ValidationGroup="Check"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox id="BankName" runat="server" MaxLength="50" ValidationGroup="Check"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox id="RoutingNumber" runat="server" MaxLength="9" ValidationGroup="Check"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox id="BankAccountNumber" runat="server" ValidationGroup="Check"></asp:TextBox><span class="requiredField">*</span>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:HyperLink ID="CancelLink" runat="server" Text="Cancel" SkinID="CancelButton" NavigateUrl="~/Admin/Orders/Payments/Default.aspx"></asp:HyperLink>
                </td>
            </tr>
        </table>
    </ContentTemplate>
