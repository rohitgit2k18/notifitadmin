//-----------------------------------------------------------------------
// <copyright file="CreateOrder1.aspx.cs" company="Able Solutions Corporation">
...
namespace AbleCommerce.Admin.Orders.Create
{
    ...
    public partial class CreateOrder1 : CommerceBuilder.UI.AbleCommerceAdminPage
    {
        ...
        protected void NewUserButton_Click(object sender, EventArgs e)
        {
            ...
            if (user == null)
            {
                ...
                user.Save();
                user.Basket.Save();
                Session["CreateOrder_AnonUserId"] = user.Id;
            }
            Response.Redirect("CreateOrder2.aspx?UID=" + user.Id);
        }
    }
}