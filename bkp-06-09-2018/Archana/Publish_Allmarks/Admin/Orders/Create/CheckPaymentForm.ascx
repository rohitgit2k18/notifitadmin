<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Orders.Create.CheckPaymentForm" EnableViewState="false" CodeFile="CheckPaymentForm.ascx.cs" %>
<table class="paymentForm">
    ...
    <tr id="trAmount" runat="server">
        ...
        <td>
            <asp:TextBox ID="Amount" runat="server" Text="" Width="60px" MaxLength="10" ValidationGroup="Check"></asp:TextBox><span class="requiredField">*</span>
    ...
    <tr>
        ...
        <td rowspan="5">
            <asp:Image ID="CheckHelpImage" runat="server" SkinID="CheckHelp"/>
        </td>
    </tr>
    <tr>
        <th>
    ...
    <tr id="trSortCode" runat="server">
        ...
        <td>
            <asp:TextBox id="SortCode" runat="server" MaxLength="20" ValidationGroup="Check"></asp:TextBox><span class="requiredField">*</span>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox id="AccountNumber" runat="server" ValidationGroup="Check"></asp:TextBox><span class="requiredField">*</span>
