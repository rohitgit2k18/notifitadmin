<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Orders.Create.MiniBasket" CodeFile="MiniBasket.ascx.cs" %>
...
<asp:UpdatePanel ID="BasketPanel" runat="server" UpdateMode="Always">
    <ContentTemplate>
        <asp:Panel ID="MiniBasketHolder" runat="server" CssClass="section">
            <div class="header">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="right" valign="top" width="60px">
                                        <%#GetItemShopPrice((BasketItem)Container.DataItem).LSCurrencyFormat("ulc")%>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
