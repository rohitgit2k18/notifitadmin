<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Orders.Create.CreateOrder4" Title="Place Order" CodeFile="CreateOrder4.aspx.cs" %>
            ...
            <div class="mainColumn">
                <div class="content">
                                ...
                                <td>
                                    ...
                                    <asp:Repeater ID="ShipmentList" runat="server" OnItemDataBound="ShipmentList_ItemDataBound">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="ShipMethodListLabel" runat="server" Visible='<%# (ShipmentCount == 1) %>' Text="Select Shipping Method:" SkinID="FieldHeader"></asp:Label>&nbsp;
                    ...
                    <table class="inputForm" cellpadding="3" width="100%">
                        <tr>
                            <td class="sectionHeader" colspan="2">
                                <asp:Localize ID="PaymentMethodCaption" runat="server" Text="Payment Method (Order Total: {0})" EnableViewState="false"></asp:Localize> 
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" valign="top">
                                ...
                                <uc:DeferPaymentForm ID="DeferPaymentForm" runat="server" ValidationGroup="OPC" ValidationSummaryVisible="false" Visible="false" />
                                <asp:HiddenField ID="OrderTotal" runat="server" />
                            </td>
                        </tr>
                    </table>
