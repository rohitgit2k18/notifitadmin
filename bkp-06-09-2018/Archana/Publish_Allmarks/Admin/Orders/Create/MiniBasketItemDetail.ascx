<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Orders.Create.MiniBasketItemDetail" EnableViewState="false" CodeFile="MiniBasketItemDetail.ascx.cs" %>
<%-- 
<conlib>
...
<asp:PlaceHolder ID="SubscriptionPanel" runat="server">
    ...
    <asp:Literal ID="InitialPayment" runat="server" Text="Initial Payment: {0}<br />"></asp:Literal>
    <asp:Literal ID="RecurringPayment" runat="server" Text="Recurring Payment: {0} payments of {1}, every {2}."></asp:Literal>
</asp:PlaceHolder>
