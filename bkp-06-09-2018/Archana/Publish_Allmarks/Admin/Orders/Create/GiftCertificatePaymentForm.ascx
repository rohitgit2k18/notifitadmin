<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Orders.Create.GiftCertificatePaymentForm" CodeFile="GiftCertificatePaymentForm.ascx.cs" %>
<table class="paymentForm">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="GiftCertificateNumber" runat="server" MaxLength="50" ValidationGroup="GiftCertificate"></asp:TextBox><span class="requiredField">*</span>
