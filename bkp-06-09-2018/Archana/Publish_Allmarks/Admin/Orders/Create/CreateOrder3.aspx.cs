//-----------------------------------------------------------------------
// <copyright file="CreateOrder3.aspx.cs" company="Able Solutions Corporation">
...
namespace AbleCommerce.Admin.Orders.Create
{
    ...
    public partial class CreateOrder3 : CommerceBuilder.UI.AbleCommerceAdminPage
    {
        private int _UserId;
        private User _User;
        Basket _Basket;
        ...
        private int GetShippingAddressId()
        {
            ...
            return _User.PrimaryAddress.Id;
        }
        ...
        private void SelectCountry(DropDownList CountryList, string countryCode, TextBox ProvinceText, DropDownList ProvinceList, RequiredFieldValidator PostalCodeValidator)
        {
            ...
            if (index < 0) index = this.Countries.IndexOf(AbleContext.Current.Store.DefaultWarehouse.CountryCode);
        ...
        private void UpdateProvinces(string countryCode, TextBox ProvinceText, DropDownList ProvinceList, RequiredFieldValidator PostalCodeValidator)
        {
            ...
            IList<Province> provinces = ProvinceDataSource.LoadForCountry(countryCode, "Name");
        ...
        private void InitializeAddressBook()
        {
            ...
            int defaultIndex = addresses.IndexOf(AlwaysConvert.ToInt(_User.PrimaryAddressId));
