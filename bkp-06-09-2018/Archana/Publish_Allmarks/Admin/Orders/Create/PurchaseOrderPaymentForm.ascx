<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Orders.Create.PurchaseOrderPaymentForm" CodeFile="PurchaseOrderPaymentForm.ascx.cs" %>
<table class="paymentForm">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="PurchaseOrderNumber" runat="server" MaxLength="50" ValidationGroup="PurchaseOrder"></asp:TextBox><span class="requiredField">*</span>
