<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Orders.Create.CreditCardPaymentForm" CodeFile="CreditCardPaymentForm.ascx.cs" %>
...
<table class="paymentForm">
    ...
    <tr id="trAmount" runat="server">
        ...
        <td>
            <asp:TextBox ID="Amount" runat="server" Text="" Width="60px" MaxLength="10" ValidationGroup="CreditCard"></asp:TextBox><span class="requiredField">*</span> 
        ...
        <td>
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td valign="top">
                        <asp:Image ID="CID" runat="server" SkinID="CID" />
                    </td>
                    <td valign="top">
                ...
                <tr>
                    <td valign="top">
                        <asp:Image ID="AmexCID" runat="server" SkinID="AmexCID"/>
                    </td>
                    <td valign="top">
