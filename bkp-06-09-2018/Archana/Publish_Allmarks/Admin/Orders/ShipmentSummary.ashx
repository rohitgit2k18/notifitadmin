<%@ WebHandler Language="C#" Class="AbleCommerce.Admin.Orders.OrderShipmentSummary" %>
    ...
    public class OrderShipmentSummary : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (shipment != null)
            {
                ...
                context.Response.Write("<div class=\"header\"><h2>Order #" + order.OrderNumber + ", Shipment #" + shipment.ShipmentNumber.ToString() + " Contents</h2></div>\r\n");
                context.Response.Write("<div class=\"content\">");
                context.Response.Write("<table class=\"pagedList\" cellpadding=\"4\" cellspacing=\"0\" width=\"100%\">\r\n");
