<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" Inherits="AbleCommerce.Admin.Catalog.EditLink" Title="Edit Link" CodeFile="EditLink.aspx.cs" AutoEventWireup="True" %>
    ...
    <div class="pageHeader">
    	<div class="caption">
            ...
            <div class="links">
                ...
                <asp:HyperLink ID="PreviewButton" runat="server" Text="Preview" SkinID="CancelButton" Target="_blank" />
            </div>
    	</div>
    </div>
    <div class="content">
	    <asp:ValidationSummary ID="ErrorSummary" runat="server" />
		<cb:Notification ID="SavedMessage" runat="server" Text="Link saved at {0:t}" SkinID="GoodCondition" EnableViewState="False" Visible="false"></cb:Notification>
        <table class="inputForm">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="ThumbnailUrl" runat="server" MaxLength="250" width="300px"></asp:TextBox>&nbsp;
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="Summary" runat="server" Text="" TextMode="multiLine" Rows="5" MaxLength="1000" Width="100%"></asp:TextBox><br />
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="MetaDescriptionValue" runat="server" Text="" TextMode="multiLine" Rows="5" MaxLength="300" Columns="140"></asp:TextBox><br />
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="MetaKeywordsValue" runat="server" Text="" TextMode="multiLine" Rows="5" Columns="140" MaxLength="1000"></asp:TextBox><br />
        ...
        <br />
        <div class="links">
            <asp:Button ID="FinishButton2" runat="server" Text="Save and Close"  OnClick="FinishButton_Click" />
			<asp:Button ID="SaveButton2" runat="server" Text="Save"  OnClick="SaveButton_Click" />
            ...
            <asp:HyperLink ID="PreviewButton2" runat="server" Text="Preview" SkinID="CancelButton" Target="_blank" />
        </div>
    </div>
</asp:Content>