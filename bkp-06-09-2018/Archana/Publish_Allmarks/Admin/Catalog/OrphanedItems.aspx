<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Catalog.OrphanedItems" Title="Orphaned Items" CodeFile="OrphanedItems.aspx.cs" %>
        ...
        <ContentTemplate>
            <div class="searchPanel">
                <div class="reportNav">
                    ...
                    <asp:DropDownList ID="CatalogItemTypeList" runat="server" OnSelectedIndexChanged="CatalogItemTypeList_SelectedIndexChanged" AutoPostBack="true">
            ...
            <asp:Panel ID="CatalogItemsPanel" runat="server" CssClass="content">
            ...
            <asp:Panel ID="ImagesPanel" runat="server" CssClass="content" Visible="false">
                <p>List of files that are present in the "~Assets/ProductImages" folder at your store and are not associated to any product, category or link.</p>
                ...
                <cb:SortedGridView ID="ImageFilesGrid" runat="server" AutoGenerateColumns="false" 
                    ShowHeader="true" ShowFooter="false" SkinID="PagedList"
                    Width="100%" DataKeyNames="Name" AllowPaging="true" PageSize="20"
