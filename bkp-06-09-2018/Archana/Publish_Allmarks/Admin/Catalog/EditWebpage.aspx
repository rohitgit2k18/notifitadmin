<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Catalog.EditWebpage" Title="Edit Webpage" CodeFile="EditWebpage.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="content">
        <cb:Notification ID="SavedMessage" runat="server" Text="Webpage saved at {0:t}" SkinID="GoodCondition" EnableViewState="False" Visible="false"></cb:Notification>
