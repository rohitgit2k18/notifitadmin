<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Catalog.Search" Title="Search Catalog" CodeFile="Search.aspx.cs" %>
        ...
        <ContentTemplate>
            ...
            <div class="grid_3 alpha">
                <div class="leftColumn">
    		        <asp:Panel ID="SearchPanel" runat="server" CssClass="section" DefaultButton="SearchButton" EnableViewState="false">
		                <div class="header">
			            ...
			            <div class="content">
	                        <asp:Label ID="SearchInstructionText" runat="server" Text="Enter all or part of the phrase you are searching for." EnableViewState="false"></asp:Label><br />
                            ...
                            <asp:Button ID="SearchButton" runat="server" Text="Search" OnClientClick="this.value='Searching...'" EnableViewState="false" />
		                </div>
	                </asp:Panel>
                </div>
            </div>
            <div class="grid_9 omega">
                <div class="mainColumn">
                    <div class="section">
                        ...
                        <div class="content">
                            <asp:GridView ID="CGrid" runat="server" AutoGenerateColumns="False" Width="100%" DataKeyNames="Id,CatalogNodeType" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Name">
                                        <ItemTemplate>
                                            ...
                                            --%>
                                            <asp:LinkButton ID="N" runat="server" Text='<%# Eval("Name") %>' CommandName="Do_Open" CommandArgument='<%#string.Format("{0}|{1}", Eval("CatalogNodeTypeId"), Eval("Id"))%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="C" runat="server" CommandName="Do_Copy" CommandArgument='<%#string.Format("{0}|{1}", Eval("CatalogNodeTypeId"), Eval("Id"))%>' Visible='<%#((CatalogNodeType)Eval("CatalogNodeType") != CatalogNodeType.Category) %>'><img src="<%# GetIconUrl("copy.gif") %>" alt="Copy" border="0" /></asp:LinkButton>
                                            <asp:LinkButton ID="P" runat="server" CommandName="Do_Pub" CommandArgument='<%#string.Format("{0}|{1}", Eval("CatalogNodeTypeId"), Eval("Id"))%>'><img src="<%# GetVisibilityIconUrl(Container.DataItem) %>" border="0" alt="<%#Eval("Visibility")%>" /></asp:LinkButton>
                                            <a href="<%# GetEditUrl(Eval("CatalogNodeType"), Eval("Id")) %>"><img src="<%# GetIconUrl("edit.gif") %>" border="0" alt="Edit" /></a>
                                            <a href="<%# GetMoveUrl(Eval("CatalogNodeType"), Eval("Id")) %>"><img src="<%# GetIconUrl("move.gif") %>" border="0" alt="Move" /></a>
                                            <asp:LinkButton ID="D" runat="server" CommandName="Do_Delete" CommandArgument='<%#string.Format("{0}|{1}", Eval("CatalogNodeTypeId"), Eval("Id"))%>'><img src="<%# GetIconUrl("delete.gif") %>" border="0" alt="Delete" /></asp:LinkButton>
                                        </ItemTemplate>
