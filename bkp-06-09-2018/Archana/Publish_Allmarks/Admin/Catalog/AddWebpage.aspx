<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Catalog.AddWebpage" Title="Add Web Page" CodeFile="AddWebpage.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="pageHeader">
        <div class="caption">
            ...
            <div class="links">
                <asp:Button ID="FinishButton" runat="server" SkinID="SaveButton" Text="Save and Edit" OnClick="FinishButton_Click" />
                <asp:HyperLink ID="CancelButton" runat="server" Text="Cancel" SkinID="CancelButton" NavigateUrl="Browse.aspx" />
            </div>
        </div>
    </div>
    <div class="content">
        ...
        <asp:ImageButton ID="ContentHtmlButton" runat="server" SkinID="HtmlIcon" AlternateText="Edit HTML" />
        <cb:HtmlEditor ID="WebpageContent" runat="server" Height="200px" Width="100%" Mode="Inline"></cb:HtmlEditor>    
        <div class="sectionHeader">
        ...
        <table class="inputForm">
            ...
            <tr>
                <th valign="top" width="100px">
                    <cb:ToolTipLabel ID="CategoryTreeLabel" runat="server" Text="Category:" AssociatedControlId="CategoryTree1" ToolTip="Specifies the category or categories that will include this webpage."></cb:ToolTipLabel>
                </th>
                <td>
                    <uc:CategoryTree ID="CategoryTree1" runat="server"></uc:CategoryTree>
                </td>
            </tr>
            <tr>
                <th >
        ...
        <br />
        <div class="links">
            <asp:Button ID="FinishButton2" runat="server" SkinID="SaveButton" Text="Save and Edit" OnClick="FinishButton_Click" />
            <asp:HyperLink ID="CancelButton2" runat="server" Text="Cancel" SkinID="CancelButton" NavigateUrl="Browse.aspx" />
        </div>
    </div>
</asp:Content>