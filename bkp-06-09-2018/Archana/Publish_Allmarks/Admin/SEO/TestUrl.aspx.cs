...
{
public partial class TestUrl : CommerceBuilder.UI.AbleCommerceAdminPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        AbleCommerce.Code.PageHelper.SetDefaultButton(RequestUrl, TestButton);
    }
    ...
    protected void TestButton_Click(object sender, EventArgs e)
    {
        ...
        // Have application-wide rewrite option
        bool rewriteEnabled = ApplicationSettings.Instance.UrlRewriterEnabled;
        ...
        do{
            ...
            IRedirectService redirectService = AbleContext.Resolve<IRedirectService>();
            Redirect r = redirectService.LocateRedirect(redirectUrl);
            if (r != null)
            {
