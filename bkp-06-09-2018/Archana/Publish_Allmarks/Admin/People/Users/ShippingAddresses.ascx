<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.People.Users.ShippingAddresses" CodeFile="ShippingAddresses.ascx.cs" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <script type="text/javascript">
            function deleteConfirmation() {
                var sAddress = $('#<%=ShippingAddressList.ClientID%>  option:selected').text();
                return confirm("Are you sure you want to delete '" + sAddress + "'?");
            }
        </script>
        <div class="content">
            <asp:PlaceHolder ID="ViewPH" runat="server">
                <table class="inputForm ShippingAddressList">
                    <tr>
                        <th>
                            <asp:Label ID="SelectAddressLabel" runat="server" EnableViewState="false" Text="Select Address: " CssClass="fieldHeader"></asp:Label>
                        </th>
                        <td>
                            <asp:DropDownList ID="ShippingAddressList" runat="server" EnableViewState="true"/>&nbsp;
                            <asp:Button ID="EditAddressButton" runat="server" Text="Edit" OnClick="EditAddressButton_Click" />
                            <asp:Button ID="DeleteAddressButton" runat="server" Text="Delete" OnClick="DeleteAddressButton_Click" OnClientClick="return deleteConfirmation();" />
                        </td>
                    </tr>
                </table>
            </asp:PlaceHolder>
            <asp:PlaceHolder ID="EditPH" runat="server" Visible="false">
                ...
                <asp:HiddenField ID="AddressId" runat="server" />
