<%@ Page Language="C#" MasterPageFile="../../Admin.master" Inherits="AbleCommerce.Admin.People.Subscriptions.SubscriptionPlans" Title="Subscription Plans"  CodeFile="SubscriptionPlans.aspx.cs" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="pageHeader">
    	<div class="caption">
            ...
            <div class="links">
                <cb:NavigationLink ID="DetailsLink" runat="server" Text="Subscription List" SkinID="Button" NavigateUrl="Default.aspx" EnableViewState="false"></cb:NavigationLink>
                <cb:NavigationLink ID="SummaryLink" runat="server" Text="Plan Summary" SkinID="ActiveButton" NavigateUrl="#" EnableViewState="false"></cb:NavigationLink>
            </div>
    	</div>
    </div>
    <div class="content">
        <asp:UpdatePanel ID="SubscriptionAjax" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <cb:SortedGridView ID="SubscriptionPlanGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductId" DataSourceID="SubscriptionPlanDs" 
                    SkinID="PagedList" AllowSorting="True" DefaultSortExpression="Name" DefaultSortDirection="Ascending" ShowWhenEmpty="False" Width="100%">
                    <Columns>
                        <asp:TemplateField HeaderText="Subscription Plan" SortExpression="Name">
    ...
    <asp:ObjectDataSource ID="SubscriptionPlanDs" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="LoadAll" TypeName="CommerceBuilder.Products.SubscriptionPlanDataSource" DataObjectTypeName="CommerceBuilder.Products.SubscriptionPlan"
