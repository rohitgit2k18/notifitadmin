<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.UserControls.OrderItemDetail" CodeFile="OrderItemDetail.ascx.cs" %>
<%-- 
<conlib>
...
--%>
<div class="itemDetail orderItemDetail">
    ...
    <asp:ListView ID="InputList" runat="server">
        ...
        <ItemTemplate>
            <li>
                <span class="label"><%#Eval("Name", "{0}")%>:</span>
