<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.DigitalGoods.DigitalGoodFiles" Title="View Files in Digital Goods Folder" CodeFile="DigitalGoodFiles.aspx.cs" %>
...
<asp:UpdatePanel ID="PageAjax" runat="server">
    ...
    <ContentTemplate>    
        ...
        <div class="pageHeader">
            <div class="caption">
                ...
                <div class="links">
                    ...
                    <cb:NavigationLink ID="FileView" runat="server" Text="Digital Files" NavigateUrl="#" SkinID="ActiveButton" EnableViewState="false"></cb:NavigationLink>
                    <cb:NavigationLink ID="Readmes" runat="server" Text="Readmes" SkinID="Button" NavigateUrl="Readmes.aspx"></cb:NavigationLink>
                    <cb:NavigationLink ID="Agreements" runat="server" Text="Agreements" SkinID="Button" NavigateUrl="Agreements.aspx"></cb:NavigationLink>
                </div>
            </div>
        </div>
        <div class="content">
            <div class="links">
                    <asp:LinkButton ID="AddFolderLink" runat="server" Text="Create Folder" SkinID="AddButton" EnableViewState="false"></asp:LinkButton>
                    <asp:HyperLink ID="UploadFileLink" runat="server" Text="Upload File" SkinID="AddButton" NavigateUrl="javascript:showUploadDialog()" EnableViewState="false"></asp:HyperLink>
            </div>
                ...
                <asp:Panel ID="UploadDialog" runat="server" style="display:none">
                    <table class="inputForm">
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <asp:FileUpload ID="UploadFile" runat="server" Width="400px" OnBlur="setNames()"/><span class="requiredField">*</span>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="CancelUploadButton" runat="server" Text="Cancel" SkinId="CancelButton" OnClientClick="hideUploadDialog();return false;" CausesValidation="false" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                ...
                <ContentTemplate>
                    <asp:GridView ID="FileGrid" runat="server" AllowPaging="false" AutoGenerateColumns="False" SkinID="PagedList" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemStyle HorizontalAlign="Right" Width="108px" />
                                <ItemTemplate>
                                    ...
                                    <asp:PlaceHolder ID="FileLinks" runat="server" Visible='<%#Eval("IsFile")%>'>
                                        ...
                                        <asp:ImageButton ID="AddLink" runat="server" CommandName="AddDigitalGood" CommandArgument='<%# Eval("FileName") %>' AlternateText="Add Digital Good" SkinID="AddFileIcon" EnableViewState="false" />
                                        <asp:ImageButton ID="RenameLink" runat="server" CommandName="RenameFile" CommandArgument='<%# Eval("FileName") %>' AlternateText="Rename" SkinID="FileChangeIcon" EnableViewState="false" />
                        ...
                        <div style="padding-top:5px;">
                            <table class="inputForm" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="Name" runat="server" Text="" MaxLength="100" Width="300px" ValidationGroup="Add" /><span class="requiredField">*</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button ID="CancelAddButton" runat="server" Text="Cancel" SkinId="CancelButton" CausesValidation="false" /><br />
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div style="padding-top:5px;">
                            <table class="inputForm" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="RenameNewFilename" runat="server" MaxLength="100" Width="200px"></asp:TextBox><span class="requiredField">*</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button ID="CancelRenameButton" runat="server" Text="Cancel" SkinId="CancelButton" CausesValidation="false" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <ajaxToolkit:ModalPopupExtender ID="DeletePopup" runat="server" 
            ...
            <div style="padding-top:5px;">
                ...
                <table class="inputForm" cellpadding="3">
                    <tr>
                        ...
                        <td valign="top">
                            <asp:TextBox ID="NewFolderName" runat="server" Width="200px"></asp:TextBox><br /><span class="requiredField">*</span>
                        ...
                        <td valign="top" style="white-space:nowrap">
                            ...
                            <asp:Button ID="NewFolderCancelButton" runat="server" Text="Cancel" SkinId="CancelButton" CausesValidation="false" />
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
        ...
        <ajaxToolkit:ModalPopupExtender ID="NewFolderPopupExtender" runat="server" 
