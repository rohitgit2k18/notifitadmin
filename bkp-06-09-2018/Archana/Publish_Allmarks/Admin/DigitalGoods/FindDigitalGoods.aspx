<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.DigitalGoods.FindDigitalGoods" Title="Find Digital Goods" CodeFile="FindDigitalGoods.aspx.cs" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content">
        <p><asp:Label ID="InstructionText" runat="server" Text="Enter all or part of a digital good name.  Wildcard characters * and ? are accepted.  You can also leave the name field empty to show all."></asp:Label></p>
        <asp:UpdatePanel ID="SearchAjax" runat="server">
            <ContentTemplate>
                ...
                <cb:SortedGridView ID="SearchResultsGrid" runat="server" AutoGenerateColumns="false" 
                    ShowHeader="true" ShowFooter="false" DataKeyNames="Id" SkinID="PagedList"
