<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.DigitalGoods.EditDigitalGood" Title="Edit Digital Good" CodeFile="EditDigitalGood.aspx.cs" %>
...
<asp:UpdatePanel ID="PageAjax" runat="server">
    <ContentTemplate>
        ...
        <div class="content">
            <cb:Notification ID="SavedMessage" runat="server" Text="Digital good saved at {0:t}" EnableViewState="false" Visible="false" SkinID="GoodCondition"></cb:Notification>
            ...
            <table cellpadding="3" cellspacing="0" class="inputForm" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="Name" runat="server" Text="" MaxLength="100" Width="300px" /><span class="requiredField">*</span>
                ...
                <tr>
                    <th valign="top">
                        <cb:ToolTipLabel ID="GroupsLable" runat="server" Text="Groups:" ToolTip="Groups associated with this digital good." />
                        
                    </th>
                    <td>
                        <asp:UpdatePanel ID="GroupAjax" runat="server" UpdateMode="conditional" EnableViewState="false">
                            <ContentTemplate>
                                <asp:ListBox ID="Groups" runat="server" SelectionMode="Multiple" Height="100px" Width="250px" DataTextField="Name" DataValueField="GroupId" EnableViewState="false" />
                                <asp:HiddenField ID="NewName" runat="server" EnableViewState="false" />
                                <asp:LinkButton ID="NewGroupButton" runat="server" OnClientClick="return addGroup()" SkinID="Link" Text="add new" CausesValidation="false" EnableViewState="false" OnClick="NewGroupButton_Click" TabIndex="3"></asp:LinkButton>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                </tr>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="UpdateButton" runat="server" Text="Save" OnClick="UpdateButton_Click" />
            ...
            <div style="padding-top:5px;">
                <table class="inputForm" cellpadding="3">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="RenameFileName" runat="server" MaxLength="100" Width="200px"></asp:TextBox><span class="requiredField">*</span>
