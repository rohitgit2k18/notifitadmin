<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin.DigitalGoods._DigitalGoods" Title="Manage Digital Goods" CodeFile="DigitalGoods.aspx.cs" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="pageHeader">
    	<div class="caption">
            ...
            <div class="links">
                <cb:NavigationLink ID="ManageDGView" runat="server" Text="Manage Digital Goods" SkinID="ActiveButton" NavigateUrl="#"></cb:NavigationLink>
    ...
    <Triggers>
        ...
        <asp:PostBackTrigger ControlID="AddAndEditButton" />
    </Triggers>
        <ContentTemplate>
            <div class="searchPanel">
                <table class="inputForm">
                    ...
                    <tr>
                        <th>
                            <asp:Localize ID="SearchDGNameLabel" runat="server" Text="Digital Name:" EnableViewState="false"></asp:Localize>
                        </th>
                        <td>
                            <asp:TextBox ID="SearchDGName" runat="server" Width="250px" MaxLength="200"></asp:TextBox>
                        </td>
                        <th>
                            <asp:Localize ID="SearchDGFileNameLabel" runat="server" Text="File Name:" EnableViewState="false"></asp:Localize>
                        </th>
                        <td>
                            <asp:TextBox ID="SearchDGFileName" runat="server" Width="250px" MaxLength="200"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                            ...
                            <asp:HyperLink ID="ResetButton" runat="server" Text="Reset" NavigateUrl="DigitalGoods.aspx" SkinID="CancelButton"></asp:HyperLink>
                            <asp:HyperLink ID="AddLink" runat="server" Text="Add Digital Good" NavigateUrl="#" SkinID="AddButton" EnableViewState="false"></asp:HyperLink>   
                        </td>
                    </tr>
                </table>
            </div>
            <div class="content">
                <cb:SortedGridView ID="DigitalGoodGrid" runat="server" AllowPaging="true" AllowSorting="true" PageSize="20"
                    AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="DigitalGoodDs" 
                ...
                <p class="intro"><asp:Localize ID="InstructionText" runat="server" Text="Distribute downloadable files by creating a Digital Good and assigning it to a product."></asp:Localize></p>
            </div>
