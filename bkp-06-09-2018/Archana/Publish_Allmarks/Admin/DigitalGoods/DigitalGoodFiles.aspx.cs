...
{
public partial class DigitalGoodFiles : CommerceBuilder.UI.AbleCommerceAdminPage
{
    ...
    protected void DeleteButton_Click(object sender, EventArgs e)
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            {
                IList<DigitalGood> goods = GetFileDigitalGoods(fileName);
                goods.DeleteAll();
            }
        }
    ...
    public class FileDigitalGood
    {
        ...
        private IList<DigitalGood> _DigitalGoods;
        ...
        public FileDigitalGood(string fileName, string fileSize, IList<DigitalGood> digitalGoods)
        {
            _FileName = fileName;
        ...
        public IList<DigitalGood> DigitalGoods
        {
