<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin.Dashboard.UserStatus" EnableViewState="false" CodeFile="UserStatus.ascx.cs" %>
...
<asp:UpdatePanel ID="ChangePasswordAjax" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="ChangePasswordPanel" runat="server" HorizontalAlign="center" visible="false" DefaultButton="ChangePasswordButton">
            <table class="dialog" cellpadding="4" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="CurrentPassword" runat="server" Font-Size="0.8em" TextMode="Password" ValidationGroup="UserStatus"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="NewPassword" runat="server" Font-Size="0.8em" TextMode="Password" ValidationGroup="UserStatus"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="ConfirmNewPassword" runat="server" Font-Size="0.8em" TextMode="Password" ValidationGroup="UserStatus"></asp:TextBox><span class="requiredField">*</span>
