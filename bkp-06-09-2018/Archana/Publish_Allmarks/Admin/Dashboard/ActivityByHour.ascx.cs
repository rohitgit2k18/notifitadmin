namespace AbleCommerce.Admin.Dashboard
{
    ...
    public partial class ActivityByHour : System.Web.UI.UserControl
    {
        protected void ActivityByHourTimer_Tick(object sender, EventArgs e)
        {
            ...
            initDayChart();
            initMonthChart();
            ActivityByHourTimer.Enabled = false;
