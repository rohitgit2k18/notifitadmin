<%@ Control Language="C#" AutoEventWireup="True" Inherits="AbleCommerce.ConLib.CategoryGridPageHome" CodeFile="CategoryGridPageHome.ascx.cs" %>
<%--
<conlib>
        ...
        <div class="col-md-6">
	        <div class="section">
		        <div class="pageHeader">
	                ...
	                <div class="section">
                        <div class="content">
                            <h1><asp:Literal ID="CategorySummary" runat="server" EnableViewState="false"></asp:Literal></h1>
		                </div>
                    </div>
                    </asp:PlaceHolder>
		        </div>
            ...
            <div class="section">
                <div class="search">
                    <uc:SimpleSearch ID="SimpleSearch3" runat="server"/>
                </div>
            </div>
        </div>
                    ...
                    <cb:ExDataList ID="CatalogNodeList" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" Width="100%" 
                        ...
                        <ItemTemplate>
                            <div class="itemContainer">
                                <asp:HyperLink ID="CategoryItemUrl" runat="server" NavigateUrl='<%# GetCategoryUrl(Container.DataItem) %>' CssClass="product-anchor" Text="Contact Us">
