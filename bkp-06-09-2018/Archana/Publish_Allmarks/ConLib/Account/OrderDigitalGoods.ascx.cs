...
namespace AbleCommerce.ConLib.Account
{
    ...
    [Description("Displays digital goods for an order")]
    public partial class OrderDigitalGoods : System.Web.UI.UserControl
    {
        ...
        protected string GetDownloadUrl(object dataItem)
        {
            ...
            {
                string downloadUrl = this.Page.ResolveUrl("~/Members/Download.ashx?id=" + oidg.Id.ToString());
                if ((dg.LicenseAgreementMode & LicenseAgreementMode.OnDownload) == LicenseAgreementMode.OnDownload)
                {
                    if (dg.LicenseAgreement != null)
                    {
                        ...
                        string agreeUrl = this.Page.ResolveUrl("~/ViewLicenseAgreement.aspx") + "?id=" + dg.LicenseAgreement.Id + "&AcceptUrl=" + acceptUrl + "&DeclineUrl=" + declineUrl;
                    ...
                    if (dg != null)
                    {
                        if ((dg.LicenseAgreement != null) || (dg.Readme != null))
                        {
                            ...
                            if (phAssets != null)
                            {
                                ...
                                string agreeUrl = this.Page.ResolveUrl("~/ViewLicenseAgreement.aspx") + "?id={0}&ReturnUrl=" + encodedUrl;
