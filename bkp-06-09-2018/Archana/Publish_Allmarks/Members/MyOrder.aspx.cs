namespace AbleCommerce.Members
{
    ...
    public partial class MyOrder : CommerceBuilder.UI.AbleCommercePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (_Order == null) Response.Redirect(AbleCommerce.Code.NavigationHelper.GetStoreUrl(this.Page, "Members/MyAccount.aspx"));
            if (_Order.User != null && _Order.User.Id != AbleContext.Current.UserId) Response.Redirect(AbleCommerce.Code.NavigationHelper.GetStoreUrl(this.Page, "Members/MyAccount.aspx"));
            ...
            else if (unpaidBalance > 0 && !OrderHasSubscriptionPayments(_Order))
            {
                ...
                BalanceDueMessage.Text = string.Format(BalanceDueMessage.Text, unpaidBalance.LSCurrencyFormat("ulc"), this.Page.ResolveUrl("~/Members/PayMyOrder.aspx?OrderNumber=" + _Order.OrderNumber.ToString()));
            }
            ...
            if (this.IsRepeatable)
            {
                ...
                ReorderButton.NavigateUrl = "~/Reorder.ashx?o=" + _Order.Id.ToString();
            }
        }
                ...
                if (order.OrderStatus.IsValid && balance > 0)
                {
                    ...
                    if (lastPayment != null)
                    {
                        ...
                        if (authTx != null && authTx.TransactionStatus == TransactionStatus.Failed)
                        {
                            ...
                            Response.Redirect(AbleCommerce.Code.NavigationHelper.GetStoreUrl(this.Page, "Members/PayMyOrder.aspx?OrderNumber=" + order.OrderNumber.ToString()));
                        }
                    }
                }
            }
