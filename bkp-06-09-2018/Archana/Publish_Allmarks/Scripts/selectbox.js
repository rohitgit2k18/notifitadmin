...
function getOptions(obj){var str="";for(var i=0;i<obj.options.length;i++){str=str+obj.options[i].value+',';}if(str.length>0)str=str.substr(0,str.length-1);return str;}
function getOptionNames(obj){var str="";for(var i=0;i<obj.options.length;i++){str=str+obj.options[i].text+', ';}if(str.length>0)str=str.substr(0,str.length-2);return str;}