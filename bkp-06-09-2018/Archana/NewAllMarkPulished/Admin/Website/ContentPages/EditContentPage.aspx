<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Website.ContentPages.EditContentPage" Title="Edit Webpage" CodeFile="EditContentPage.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="content">
        ...
        <div class="links">
            ...
            <asp:HyperLink ID="PreviewButton2" runat="server" Text="Preview" SkinID="Button" Target="_blank" />
       </div>
    </div>  
</asp:Content>