<%@ Page Title="Product Page Usage" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ProductPageUsage.aspx.cs" Inherits="AbleCommerce.Admin.Website.ContentPages.ProductPages.ProductPageUsage" %>
...
<script language="javascript" type="text/javascript">
    function changePageConfirmation() {
        ...
        if (selectedRows > 0) {
            ...
            displayPage = $('#<%=ProductDisplayPages.ClientID %> option:selected').text();
            return confirm("Are you sure you want to reassign selected items to " + displayPage + " product page?");
        }
        else {
        ...
        <ContentTemplate>
            <div class="searchPanel">
                <table class="inputForm">
                    <tr>
                        <th>
                            <cb:ToolTipLabel ID="ProductPageLabel" runat="server" Text="Product Page:" AssociatedControlID="ProductPageList" />
                        </th>
                        <td>
                            <asp:DropDownList ID="ProductPageList" runat="server" DataSourceID="WebpagesDS" DataTextField="Name"
                                DataValueField="Id" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ProductPageList_SelectedIndexChanged">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ProductDisplayPages" runat="server" DataSourceID="WebpagesDS" 
    ...
    <div class="content">
                <cb:AbleGridView ID="ProductsGrid" DataSourceID="ProductDS"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Name">
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="Name" runat="server" NavigateUrl='<%#Eval("Id", "~/Admin/Products/EditProduct.aspx?ProductId={0}") %>' Text='<%#Eval("Name")%>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    ...
                    <EmptyDataTemplate>
                        <asp:Label ID="NoItemLabel" runat="server" Text="There are no products to list matching your criteria."></asp:Label>
                    </EmptyDataTemplate>
                </cb:AbleGridView>
                <asp:ObjectDataSource ID="ProductDS" runat="server" 
                    ...
                    OldValuesParameterFormatString="original_{0}" onselecting="ProductDS_Selecting" 
                    >
                    <SelectParameters>
