<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="True" Inherits="AbleCommerce.Admin.Website.ContentPages.CategoryPages.AddCategoryPage" Title="Add Category Page" CodeFile="AddCategoryPage.aspx.cs" %>
<%@ Register src="~/Admin/ConLib/CategoryTree.ascx" tagname="CategoryTree" tagprefix="uc" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="pageHeader">
        <div class="caption">
            <h1><asp:Localize ID="Caption" runat="server" Text="Add Category Page"></asp:Localize></h1>
            <div class="links">
        ...
        <div class="content">
            ...
            <tr>
                <th valign="top">
                    ...
                    <asp:Label ID="SummaryCharCountLabel" runat="server" Text="characters remaining"></asp:Label><span class="requiredField">*</span>
