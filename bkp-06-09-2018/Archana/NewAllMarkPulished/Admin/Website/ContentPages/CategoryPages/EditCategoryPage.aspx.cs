...
{
    public partial class EditCategoryPage : AbleCommerceAdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.UrlReferrer != null && Request.UrlReferrer.AbsolutePath.ToLowerInvariant().EndsWith("addcategorypage.aspx"))
            {
