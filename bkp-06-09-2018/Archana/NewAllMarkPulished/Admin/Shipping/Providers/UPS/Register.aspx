<%@ Page Title="UPS OnLine&reg; Tools Licensing &amp; Registration" Language="C#" MasterPageFile="~/Admin/Admin.master" Inherits="AbleCommerce.Admin.Shipping.Providers._UPS.Register" CodeFile="Register.aspx.cs" %>
        ...
        <div class="content">
            ...
            <table class="inputForm">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="ContactName" runat="server"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="ContactTitle" runat="server"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="CompanyName" runat="server"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="CompanyUrl" runat="server"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="Phone" runat="server"></asp:TextBox><span class="requiredField">*</span>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;<asp:Localize ID="OpenAccountText" runat="server" Text="To open a UPS Account, <a href='http://www.ups.com' target='_blank'>click here</a> or call 1-800-PICK-UPS."></asp:Localize>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <p><asp:Label ID="RequestContactLabel" runat="server" Text="I would like a UPS Sales Representative to contact me about opening a UPS shipping account or to answer questions about UPS services."></asp:Label></p>
                        <asp:RadioButtonList ID="RequestContact" runat="server" RepeatLayout="flow" RepeatDirection="horizontal">
                            <asp:ListItem>Yes</asp:ListItem>
                            <asp:ListItem>No</asp:ListItem>
                        </asp:RadioButtonList><span class="requiredField">*</span>
