namespace AbleCommerce.Admin._Store.Currencies
{
    ...
    public partial class AddCurrencyDialog : System.Web.UI.UserControl
    {
        ...
        protected void CreateCurrency()
        {
            if (Page.IsValid)
            {
                ...
                GroupSeparator.Text = ",";
                GroupSizes.Text = "3";
                if (ItemAdded != null) ItemAdded(this, new PersistentItemEventArgs(currency.Id, currency.Name));
