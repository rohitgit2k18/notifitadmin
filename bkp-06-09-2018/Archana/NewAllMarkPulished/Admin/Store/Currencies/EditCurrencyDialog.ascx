<%@ Control Language="C#" AutoEventWireup="true" Inherits="AbleCommerce.Admin._Store.Currencies.EditCurrencyDialog" EnableViewState="true" CodeFile="EditCurrencyDialog.ascx.cs" %>
<%@ Register assembly="wwhoverpanel" Namespace="Westwind.Web.Controls" TagPrefix="wwh" %>
<asp:UpdatePanel ID="EditCurrencyAjax" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
