<%@ Page Language="C#" MasterPageFile="../../Admin.master" AutoEventWireup="true" Inherits="AbleCommerce.Admin._Store.EmailTemplates.AddTemplate" Title="Add Email Template" CodeFile="AddTemplate.aspx.cs" %>
        ...
        <ajaxToolkit:TabPanel ID="MessageContentTab" runat="server" 
            ...
            <ContentTemplate>
                ...
                <div class="content">
                    ...
                    <p><asp:Label ID="BodyInstructionText" runat="Server" Text="Enter the details of your email template below. Both subject and body use the NVelocity template engine, providing scripting capability and dynamic variable support. For details and examples on how to leverage NVelocity scripting, view the <a href='help.aspx' target='_blank'>help</a> (new window)."></asp:Label></p>
                    <table class="inputForm" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Message" runat="Server" TextMode="multiLine" Rows="15" Width="80%"></asp:TextBox><span class="requiredField">*</span>
