namespace AbleCommerce.ConLib
{
    ...
    public partial class CategoryGridPageHome : System.Web.UI.UserControl
    {
        ...
        private class FeaturedComparer : IComparer
        {
            ...
            public int Compare(object x, object y)
            {
                ...
                if (catalogNodeX.CatalogNodeType == CatalogNodeType.Category
                    && catalogNodeY.CatalogNodeType != CatalogNodeType.Category)
                    return sortAscending ? -1 : 1;
                if (catalogNodeY.CatalogNodeType == CatalogNodeType.Category
                    && catalogNodeX.CatalogNodeType != CatalogNodeType.Category)
                    return sortAscending ? 1 : -1;
