...
{
    public partial class MyAddressBook : AbleCommercePage
    {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                if (addressId != 0)
                {
                    ...
                    if (index > -1)
                    {
                        ...
                        {
                            if (shipment.Address.Equals(address))
                            {
        ...
        protected void ShowEditPanel(int addressId)
        {
            ...
            Response.Redirect(NavigationHelper.GetMobileStoreUrl("~/Members/EditMyAddress.aspx") + queryString);
        }
