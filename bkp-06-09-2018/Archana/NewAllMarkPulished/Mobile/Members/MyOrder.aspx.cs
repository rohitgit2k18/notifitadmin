...
{
    public partial class MyOrder : AbleCommercePage
    {
                ...
                if (order.OrderStatus.IsValid && balance > 0)
                {
                    ...
                    if (lastPayment != null)
                    {
                        ...
                        if (authTx != null && authTx.TransactionStatus == TransactionStatus.Failed)
                        {
                            ...
                            Response.Redirect(NavigationHelper.GetMobileStoreUrl("~/Mobile/Members/PayMyOrder.aspx?OrderNumber=" + order.OrderNumber.ToString()));
                        }
                    }
                }
            }
